...
The task uses a set of adjacent georeferenced raster tiles (GeoTIFFs) representing a cloudless satellite scene.
Candidates must download these input files from the link below and use them for all processing and demonstration.
...
2. Last date of Submission is 18/11/2025 17:00:00 IST
